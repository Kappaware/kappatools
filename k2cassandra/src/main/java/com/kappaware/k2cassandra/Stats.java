...
public class Stats extends AbstractStats {
	...
	private Stack<ConsumerStats> consumerStatsHistory = new Stack<ConsumerStats>();
	...
	void newConsumerStats(Collection<TopicPartition> partitions) {
		if(this.consumerStats != null) {
			...
			this.consumerStatsHistory.push(this.consumerStats);
		}
	...
	public Stack<ConsumerStats> getConsumerStatsHistory() {
		return consumerStatsHistory;
	}
